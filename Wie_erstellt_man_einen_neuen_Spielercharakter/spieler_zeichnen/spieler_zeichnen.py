...
def img_into_array(file_name,normal_color,flip=False):
    ...
    for x in range(49):
        ...
        array.append(teil)
    return array
def set_img_at(img,color,normal_color):
    if color == "normal":
...
for x in range(49):
    for y in range(43):
        ...
        set_img_at(shirt_img, shirt_color,shirt_farbe,)
        if einhaendig == "links" or einhaendig == "beide":
            set_img_at(shirt_img, left_hand_color, shirt_farbe)
        if einhaendig == "rechts" or einhaendig == "beide":
            set_img_at(shirt_img, right_hand_color, shirt_farbe)
...
for x in range(49):
    for y in range(43):
        ...
        if einhaendig == "links" or einhaendig == "beide":
            set_img_at(hand_img,hand_left_color,hautfarbe_hand)
        if einhaendig == "rechts" or einhaendig == "beide":
            set_img_at(hand_img,hand_right_color,hautfarbe_hand)
...
for x in range(49):
    for y in range(43):
        ...
        set_img_at(face_img,face_color,hautfarbe_gesicht)
...
for x in range(49):
    for y in range(43):
        ...
        set_img_at(hair_img,hair_color,haarfarbe)
